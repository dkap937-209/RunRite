...
import com.dk.core.presentation.designsystem.ExclamationMarkIcon
import com.dk.core.presentation.designsystem.FinishIcon
import com.dk.core.presentation.designsystem.PauseIcon
...
@Composable
private fun TrackerScreenScreen(
    state: TrackerState,
        ...
        Column(
            ...
            Row(
                ...
                RunDataCard(
                    ...
                    valueTextColour = if(state.canTrackHeartRate){
...
@WearPreviewDevices
@Composable
private fun TrackerScreenScreenPreview() {
     RunRiteTheme {
        TrackerScreenScreen(
            state = TrackerState(
